    ...
    @if( ! $transactions->isEmpty() )
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        <th class="fit text-center @if(isset($filter['receipt_no']) || isset($filter['no_receipt'])) text-info @endif"><span class="d-none d-sm-inline">@lang('accounting::accounting.receipt') </span>#</th>
        ...
        @component('components.modal', [ 'id' => 'filterModal' ])
            ...
            <div class="form-row">
                <div class="col-sm mb-3">
                    {{ Form::bsRadioList('filter[type]', [ 'income' => __('accounting::accounting.income'), 'spending' => __('accounting::accounting.spending'), null => __('app.any'),  ], $filter['type'] ?? null, __('app.type')) }}
                </div>
                <div class="col-sm">
                    {{ Form::bsNumber('filter[receipt_no]', $filter['receipt_no'] ?? null, [ 'min' => 1 ], __('accounting::accounting.receipt') . ' #') }}
                </div>
            </div>
            <div class="form-row">
                <div class="col-sm">
            ...
            <div class="form-row">
                ...
                <div class="col-sm">
                    {{ Form::bsCheckbox('filter[no_receipt]', 1, $filter['no_receipt'] ?? false, __('accounting::accounting.no_receipt')) }}
                </div>
            </div>
            <hr>
            <div class="form-row">
